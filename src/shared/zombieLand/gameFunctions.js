const getGameFunctions = ({ gameObj = {} }) => {
  ...
  GameObj.setupGameConfig = (Phaser, parentElement = 'outputContainer', canvasElement = 'userCanvas') => {
    const Scene1 = new Phaser.Class({
      ...
      preload() {
        this.load.image('img_3500', '/images/zombieLand/assets/img_3500.jpg');
        this.load.image('playerDown', '/images/zombieLand/assets/down.png');
        this.load.image('playerUp', '/images/zombieLand/assets/up.png');
        this.load.image('playerRight', '/images/zombieLand/assets/right.png');
        this.load.image('playerLeft', '/images/zombieLand/assets/left.png');
        this.load.tilemapTiledJSON('map', '/images/zombieLand/assets/map1.json');
        this.load.image('objects', '/images/zombieLand/assets/objects.png');
        this.load.image('pond', '/images/zombieLand/assets/pond.png');
        this.load.image('goal', '/images/zombieLand/assets/goal.png');
        this.load.audio('theme', '/images/zombieLand/assets/Four_Under_the_Floor.mp3');
    ...
    const Scene2 = new Phaser.Class({
      ...
      preload() {
        ...
        this.load.image('playerRight', '/images/zombieLand/assets/right.png');
        this.load.image('playerLeft', '/images/zombieLand/assets/left.png');
        this.load.tilemapTiledJSON('map', '/images/zombieLand/assets/map2.json');
        this.load.image('objects', '/images/zombieLand/assets/objects.png');
        this.load.image('pond', '/images/zombieLand/assets/pond.png');
        this.load.image('foodBasket', '/images/zombieLand/assets/foodBucket.png');
        this.load.image('rock', '/images/zombieLand/assets/rock.png');
        this.load.audio('theme', '/images/zombieLand/assets/Four_Under_the_Floor.mp3');
        GameObj.gameData.scene = this.scene;
      },
    ...
    const Scene3 = new Phaser.Class({
      ...
      preload() {
        ...
        this.load.image('playerRight', '/images/zombieLand/assets/right.png');
        this.load.image('playerLeft', '/images/zombieLand/assets/left.png');
        this.load.tilemapTiledJSON('map', '/images/zombieLand/assets/map3.json');
        this.load.image('objects', '/images/zombieLand/assets/objects.png');
        this.load.image('pond', '/images/zombieLand/assets/pond.png');
        this.load.image('bush', '/images/zombieLand/assets/bush.png');
        this.load.image('treelog', '/images/zombieLand/assets/treeLog.png');
        this.load.image('mailBox', '/images/zombieLand/assets/mailBox.png');
        this.load.audio('theme', '/images/zombieLand/assets/Frankenstein_Goes_to_Jamaica.mp3');
        GameObj.gameData.scene = this.scene;
      },
    ...
    const Scene4 = new Phaser.Class({
      ...
      preload() {
        ...
        this.load.image('playerRight', '/images/zombieLand/assets/right.png');
        this.load.image('playerLeft', '/images/zombieLand/assets/left.png');
        this.load.tilemapTiledJSON('map', '/images/zombieLand/assets/map4.json');
        this.load.image('objects', '/images/zombieLand/assets/objects.png');
        this.load.image('pond', '/images/zombieLand/assets/pond.png');
        this.load.image('goal', '/images/zombieLand/assets/goal.png');
        this.load.image('key', '/images/zombieLand/assets/key.png');
        this.load.image('door', '/images/zombieLand/assets/trapDoor.png');
        GameObj.gameData.scene = this.scene;
      },
    ...
    const Scene5 = new Phaser.Class({
      ...
      preload() {
        ...
        this.load.image('objects', '/images/zombieLand/assets/objects.png');
        this.load.image('pond', '/images/zombieLand/assets/pond.png');
        this.load.image('sage', '/images/zombieLand/assets/sage.png');
        this.load.image('shroom', '/images/zombieLand/assets/shroom.png');
        GameObj.gameData.scene = this.scene;
      },
      ...
      create() {
        ...
        GameObj.gameData.player = this.physics.add
          ...
          .setOffset(0, 24)
          .setDepth(10);
        this.obst = this.add.sprite(this.sys.game.config.width / 2, this.sys.game.config.height / 1.5, 'pond');
        this.obst.setScale(0.5);
  ...
  GameObj.initGame = (phaser, parentElement, canvasElement, response, popupBox) => {
    GameObj.gameData.stageDataID = `Scene_${response.questionObject.qid}`;
    GameObj.gameData.popupBox = popupBox;
    GameObj.setupGameConfig(phaser, parentElement, canvasElement);
    return GameObj;
  };
