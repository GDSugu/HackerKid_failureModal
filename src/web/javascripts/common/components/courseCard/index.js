...
const TopContainer = ({
  ...
  <p className='more-info' onClick={pressMoreInfo}><FormattedMessage
    defaultMessage={'More Info'}
      description={'More Info title'} /></p></div>
    <SearchAndFilter
...
const SearchAndFilter = ({
  ...
  // onChangeFilter,
  // filterSet
}) => (<div><div className='filter-n-search'>
...
onClick={() => { onChangeFilter('Solution Videos'); setFilterVisibility(!filterVisible); }}>
<div className={`selection-circle ${(filterSet === 'Solution Videos') && 'selected'}`}></div>
<p className='mb-0'><FormattedMessage
          defaultMessage={'Solution Videos'}
          description={'Solution Videos Button'}/></p></div>
<div className='filter-cat'
onClick={() => { onChangeFilter('Session Videos'); setFilterVisibility(!filterVisible); }}>
<div className={`selection-circle ${(filterSet === 'Session Videos') && 'selected'}`}></div>
<p className='mb-0'><FormattedMessage
