    ...
    <nav className='game-navbar'>
      {
        device === 'desktop'
        && <>
          <div className="row justify-content-between align-items-center no-gutters px-3 py-1">
            ...
            <div className="col-4 flex-center">
              <div>
                <button className='btn btn-transparent level-btn'>
                  <div className="d-flex align-items-center">
                    {
                      title !== ''
                      && <>
            ...
            <div className="col-4 flex-end">
              <div className="d-flex align-items-center">
                <div>
                  <button className="btn leaderboard-btn" onClick={leaderBoardHandler}>
                    <FormattedMessage
...
export default TurtleChallengeNavBar;
